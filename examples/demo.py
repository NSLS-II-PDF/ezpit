...
input_base = "C:/Users/gkwon/PycharmProjects/pdf_soft/data/"
...
# plt.imshow(atom_distance_matrix)
# plt.show()

# qIq = lib.calculate_Iq(atom_indices, scattering_factors, atom_distance_matrix,
